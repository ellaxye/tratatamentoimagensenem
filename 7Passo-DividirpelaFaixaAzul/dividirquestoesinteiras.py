...
Padrão: 10px rgb(64,193,243), 7px rgb(179,230,250), 4px rgb(64,193,243), 8px rgb(179,230,250)
"""
...
def encontrar_padrao_faixa(imagem, tolerancia=15):
    ...
    10px rgb(64,193,243), 7px rgb(179,230,250), 4px rgb(64,193,243), 8px rgb(179,230,250)
    ...
    while y < altura - 30:
        ...
        if (abs(r - cor_azul_escura[0]) <= tolerancia and 
            ...
            # 2ª faixa azul escura: 4px ± 2px (2-6px)
            if padrao_valido:
                qtd_escura2 = 0
                while posicao_atual < altura and qtd_escura2 < 7:
                    pixel_check = pixels[x_verificacao, posicao_atual]
                    if len(pixel_check) == 4:
                        r, g, b, a = pixel_check
                    else:
                ...
                if qtd_escura2 < 2 or qtd_escura2 > 6:
                    padrao_valido = False
            
            # 2ª faixa azul clara: 8px ± 2px (6-10px)
            if padrao_valido:
                qtd_clara2 = 0
                while posicao_atual < altura and qtd_clara2 < 11:
                    pixel_check = pixels[x_verificacao, posicao_atual]
                    if len(pixel_check) == 4:
                        r, g, b, a = pixel_check
                    else:
                ...
                # Verifica se a quantidade está dentro da margem de erro (6-10px)
                if qtd_clara2 < 6 or qtd_clara2 > 10:
                    padrao_valido = False
...
def processar_imagens_especificas():
    ...
    print("📌 Padrão: 10px (64,193,243) + 7px (179,230,250) + 4px (64,193,243) + 8px (179,230,250)")
